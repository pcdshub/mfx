...
from pcdsdevices.epics_motor import MMC100, Motor
...
#        self.evr_pp = Trigger('CXI:R48:EVR:41:TRIG0',name='evr_pp')
        ...
        self.m1 = SlowMotor()
        self.m2 = SlowMotor()
        #self.split = Motor('MFX:USR:MMC:31', name='split')
        #self.split = MMC100('MFX:USR:MMC:31', name='split')
    ...
    class Chip(Device):
        ...
        def __init__(self, *args, x_prefix, y_prefix, **kwargs):
