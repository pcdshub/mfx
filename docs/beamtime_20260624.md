...
| 2 | [Shift 1 Results (June 24)](#2-shift-1-results-june-24) | What we accomplished and learned |
| 3 | [Shift 2 Plan (June 26)](#3-shift-2-plan-june-26) | Timeline and priorities for second shift |
...
### 1.9 Recipe 7: EXAFS Scan to K=12
...
### 1.10 Recipe 8: EXAFS Scan to K=16
...
## 2. Shift 1 Results (June 24)

### 2.1 Wolter Focusing Optics — First Light
...
### 2.2 Undulator K-Gap XAS Scans — Key Discovery
...
(Kelsey fixing off-shift before June 26).

---

## 3. Shift 2 Plan (June 26)

### 3.1 Priorities (ranked)

| Priority | Activity | Prerequisite | Recipe | Target |
|----------|----------|--------------|--------|--------|
| 1 (HIGH) | SEER alignment | Wolter beam through sample to SEER (downstream) | — | — |
| 2 (HIGH) | Clean up XES alignment | Kelsey crystal mount fix (off-shift) | — | — |
...
| 08:00–10:00 | **XES alignment cleanup** + **SEER alignment** | Kelsey's crystal mount fixed; align beam through sample to SEER (downstream) |
| 10:00–12:00 | **Stochastic on Fe foil** (Recipe 4) | 10K shots (~17 min); no SEER (blocks beam) |
...
### 3.4 Key Questions for EXAFS (2–4 PM)
