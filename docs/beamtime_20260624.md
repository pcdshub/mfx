...
| Priority | Activity | Prerequisite | Recipe |
|----------|----------|--------------|--------|
| 1 (HIGH) | SEER alignment on ferricyanide | Wolter beam aligned through SEER detector | — |
| 2 (HIGH) | Clean up XES alignment | Kelsey crystal mount fix (off-shift) | — |
| 3 | Stochastic XES/RIXS on Fe foil | Von Hamos aligned | 4 |
| 4 | Undulator XANES on Fe foil | — | 1 |
| 5 | Ferricyanide droplets stochastic | Von Hamos + SEER aligned | 4 |
...
The SEER spectrometer requires aligning the Wolter-focused beam's deflected
trajectory through the detector. This will require dedicated time — ideally
early in the shift so it's available for ferricyanide stochastic RIXS measurements.
...
| 08:00–10:00 | **XES alignment cleanup** + **SEER alignment** | Kelsey's crystal mount fixed; align Wolter deflected beam through SEER |
| 10:00–12:00 | **Stochastic XES on Fe foil** (Recipe 4) | 5 min collections |
| | **Undulator XANES on Fe foil** (Recipe 1) | Verify 4.5s dead-time reproducible |
| 12:00–14:00 | **Ferricyanide droplets** — stochastic (Recipe 4) | If SEER aligned: stochastic RIXS with SEER |
